            ...
            <div class="card">
                <div class="card-body register-card-body">
                    ...
                    <form method="post" action="{{ route('register') }}">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="last_name" class="form-control @error('middle_name') is-invalid @enderror" value="{{ old('last_name') }}" placeholder="Last name / Surname">
                            <div class="input-group-append">
                                <div class="input-group-text"><span class="fas fa-user"></span></div>
                            </div>
                            @error('last_name')
                        ...
                        <div class="input-group mb-3">
                            <textarea name="address" class="form-control @error('address') is-invalid @enderror" placeholder="Address">{{ old('address') }}</textarea>
                            <div class="input-group-append">
